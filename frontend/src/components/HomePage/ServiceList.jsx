    ...
    <div className="flex items-center justify-center">
      <div className="w-full lg:w-10/12 xl:w-9/12 2xl:w-6/12 text-center">
        ...
        <div className="flex justify-end">
            <Link to="/booking">
              <p className="text-orange-500 hover:text-orange-600 text-base font-poppins font-medium mt-4 transition-colors">Lainnya</p>
            </Link>
          </div>
        <div className="mt-5 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 pb-5 ">
