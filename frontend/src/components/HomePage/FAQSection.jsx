...
const FAQSection = () => {
  return (
    <div className="relative h-auto w-full md:w-3/6 bg-primary py-10 px-4 md:px-20 mx-auto my-auto rounded-2xl">
      <section className="flex flex-col md:flex-row items-center">
        ...
        <div className="flex flex-col ml-0 md:ml-10 mt-6 md:mt-0">
          ...
          <button className="mt-4 bg-orange-500 text-white text-xl py-2 px-4 rounded-md inline-block w-6/12 md:w-5/12 mx-auto md:mx-0">
            FAQ
          </button>
        </div>
      </section>
